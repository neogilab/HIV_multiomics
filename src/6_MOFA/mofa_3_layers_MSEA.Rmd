...
tax_table <- read.csv("processing/tax_table_COCOMO.csv", header = FALSE)
...
```{r}
correlations <- read.csv("processing/MOFA_correlation_clinical_parameters.csv")
