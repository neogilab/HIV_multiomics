...
```{r}
cairo_pdf("results/figures/3_clusters_gseapy_0_2_metabolites.pdf", height = 4, width = 4,family="mono")
...
```{r}
cairo_pdf("results/figures/3_clusters_gseapy_0_2_lipids.pdf", height = 4, width = 8,family="mono")
